...
## Getting help with R
If you are unclear of any function used, you may type `?` followed by function name to pull up the help documentation. Another option is to use help() function. Both options are shown below.
