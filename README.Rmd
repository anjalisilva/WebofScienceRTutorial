...
We have been selecting few fields in the publication table, but we can instead select several fields (type, year, title, ref_count) from the publication table. Type
